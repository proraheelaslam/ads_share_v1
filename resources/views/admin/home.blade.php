                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="{{asset('images/backend_images/chat-user-thumb.png')}}" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="{{asset('images/backend_images/chat-user-thumb-f.png')}}" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="{{asset('images/backend_images/weather_image.jpg')}}" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
